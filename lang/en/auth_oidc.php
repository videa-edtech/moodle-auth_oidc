...
$string['cfg_loginredirecturi_key'] = 'Login redirect URI';
$string['cfg_loginredirecturi_desc'] = 'Where to send the user after a successful login. Enter a site-relative path (e.g. <code>/vloom/dashboard/index.php</code>) or a full URL. Leave blank to use Moodle\'s default return URL (the page the user originally requested, or the site home).';
